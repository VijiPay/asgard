import { CreateUserData, IUserService, UpdateUserData } from "#interface/i_user_service";
...
export abstract class AbstractUserService implements IUserService {
  ...
  abstract lockUser(userId: number, reason: string, lockingUserId: number): Promise<User>
