...
const models: TsoaRoute.Models = {
    "IUserProfile": {
        ...
        "properties": {
            ...
            "apiKey": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},
            "profile": {"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"emailVerified":{"dataType":"boolean"},"phoneVerified":{"dataType":"boolean"},"lastLogin":{"dataType":"string","required":true},"address":{"dataType":"string","required":true},"phoneNumber":{"dataType":"string","required":true},"dateOfBirth":{"dataType":"string","required":true},"nickname":{"dataType":"string","required":true},"role":{"dataType":"string","required":true}}},{"dataType":"enum","enums":[null]}]},
